    ...
    <div class="card w-100">
          <div class="card-body p-4">
            <div class="single-order-status active" id="order-head">
              ...
              <h6 id="cancelled">Refund Request Rejected</h6>       
              </div>        
            </div>
          ...
          <div class="card-body p-4">
            <div class="single-order-status active"  id="order-head">
              ...
              <br>
              <ul class="orderUl">
                <li id="cancelled">Your Refund request has been rejected.</li>
                <li id="cancelled">You can click on HELP icon for further assistance.</li>
              </ul>
        ...
        <div class="card w-100">
          <div class="card-body p-4">
            ...
            <circle cx="8" cy="8" r="8"/></svg>
              ...
              <div class="order-text">
                <h6>Return Rejected<span>Wed, 10 Aug 2021</span></h6>
                <span>Cancelled on 10 aug 21 as issue resolved by troubleshooting.</span>
              </div>
            </div>
