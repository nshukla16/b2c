    ...
    <div class="card w-100">
          <div class="card-body p-4">
            <div class="single-order-status active" id="order-head">
              ...
              <h6 id="cancelled">Exchange Request Rejected</h6>       
              </div>        
            </div>
          ...
          <div class="card-body p-4">
            <div class="single-order-status active" id="order-head">
              <div class="order-text">    
              <h6>Info related to the exchange</h6>       
              </div>        
            </div>
              <div style="float: right;">
              ...
              <br>
              <ul class="orderUl">
                <li id="cancelled">Please repack with original packing.</li>
                <li id="cancelled">Hand over the product to delivery partner.</li>
              </ul>
              <br>
              <button class="accordion">I want to return/ exchange an item</button>
          <div class="panel">
            <p>some info...</p>
          </div>
